...
from constants import DRAW_LINE, DRAW_CONTOUR, DRAW_BOX
...
from constants import HTTP_DELAY_SECS, HTTP_FILE, LOG_LEVEL, LOG_FILE, DISPLAY
...
from constants import MINIMUM_PIXELS_DEFAULT, MINIMUM_PIXELS, MAXIMUM_OBJECTS, MAXIMUM_OBJECTS_DEFAULT
from constants import OOR_SIZE_DEFAULT, OOR_TIME, OOR_TIME_DEFAULT, OOR_UPPER, OOR_UPPER_DEFAULT
from constants import WIDTH_DEFAULT, MIDDLE_PERCENT_DEFAULT
